          ...
          <div className="hero-text order-1 lg:order-1">
            <div>
              ...
              <p style={{
                ...
                A research study for people living with bipolar depression in Stone Mountain. Up to $1,500 compensation and free round‑trip Uber to every visit.
              </p>

              {/* Balanced benefits - larger on desktop */}
              <div className="benefits-balanced grid grid-cols-2 gap-3 mt-6 mx-auto" style={{
                maxWidth: '500px'
              }}>
                <div className="benefit-pill flex items-center justify-center gap-2 lg:gap-3 px-3 py-2 lg:px-4 lg:py-3 bg-white/8 rounded-2xl lg:rounded-3xl border border-white/15 text-sm lg:text-base text-white font-medium">
                ...
                <div className="benefit-pill flex items-center justify-center gap-2 lg:gap-3 px-3 py-2 lg:px-4 lg:py-3 bg-white/15 rounded-2xl lg:rounded-3xl border border-white/25 text-sm lg:text-base text-white font-semibold">
                  <svg className="w-4 h-4 lg:w-5 lg:h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
